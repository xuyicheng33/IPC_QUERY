...
from pdf_truth import find_part_rows_on_page, parse_footer_meta_from_page, truth_parent_for_row  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument("--db", type=str, default="tmp/ipc_coords_demo.sqlite")
    parser.add_argument("--samples", type=str, default="demo_coords/qa_samples.json")
